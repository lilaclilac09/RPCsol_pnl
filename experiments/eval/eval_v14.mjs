/**
 * eval_v14 — constrained objective: ALL wallets must complete under 3000ms
 *
 * Same formula as eval_v13 but imports the phantom-token-fixed V14 solver.
 *
 ...
 *   score = base * gate
 */
import { solBalanceOverTime } from "../sol_balance/sol_balance_v14.mjs";
