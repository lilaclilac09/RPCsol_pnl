/**
 * Evaluation harness for V3 (merged anchor-sig, 2 serial round-trips).
 * Same interface as eval_v2.mjs but imports from sol_balance_v3.mjs.
 */

import { solBalanceOverTime } from "../sol_balance/sol_balance_v3.mjs";
  ...
  for (const wallet of TEST_WALLETS) {
    ...
    try {
      ...
      results.push({
        ...
        type:        wallet.type,
        wallMs:      timeout,
        rpcCalls:    strategy.maxSigPages ?? 20,
        sampleCount: 0,
        openGaps:    99,
        complete:    false,
        error:       err.message,
