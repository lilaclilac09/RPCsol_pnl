/**
 * Evaluation harness for V2 (signatures-first) autoresearch loop.
 * Same interface as eval.mjs but imports from sol_balance_v2.mjs.
 */

import { solBalanceOverTime } from "../sol_balance/sol_balance_v2.mjs";
